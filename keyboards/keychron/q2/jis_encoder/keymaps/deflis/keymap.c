...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_jis_71(
        KC_ESC,  KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    JU_6,    JU_7,    JU_8,    JU_9,    JU_0,     KC_MINS,  KC_EQL,   KC_INT3, KC_BSPC, KC_MUTE,
        ...
        MO(_FN1),KC_LOPTN, KC_LCMMD, KC_LNG2,                   KC_SPC,                    KC_LNG1, KC_RCMMD, MO(_FN1), MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_jis_71(
        ...
        KC_LCTL, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,  KC_NUHS,  KC_ENT,           KC_HOME,
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,  KC_INT1,  KC_RSFT, KC_UP,
        MO(_FN2),KC_LWIN,  KC_LALT,  KC_GRV,                    KC_SPC,                    KC_GRV,  KC_INT4,  KC_INT5,  MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    bool continue_process = process_record_user_ju(keycode, record);
